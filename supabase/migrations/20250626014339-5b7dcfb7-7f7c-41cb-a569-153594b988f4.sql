...
DROP FUNCTION IF EXISTS get_valid_perfect_corp_token();
DROP FUNCTION IF EXISTS cleanup_expired_perfect_corp_tokens();
DROP FUNCTION IF EXISTS get_token_expiry_info();
DROP FUNCTION IF EXISTS force_refresh_perfect_corp_token();
