...
export const PERFECTCORP_FILE_API_URL = `${PERFECTCORP_BASE_URL}/s2s/v1.1/file/cloth`;
export const PERFECTCORP_USER_PHOTO_URL = `${PERFECTCORP_BASE_URL}/s2s/v1.1/file/cloth`;
