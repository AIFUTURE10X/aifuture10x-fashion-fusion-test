        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 mt-32">
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl opacity-75 group-hover:opacity-100 animate-color-cycle-1 animate-border-spin blur-sm" style={{ backgroundSize: '400% 400%' }}></div>
            ...
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl opacity-75 group-hover:opacity-100 animate-color-cycle-2 animate-border-spin blur-sm" style={{ backgroundSize: '400% 400%' }}></div>
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl opacity-75 group-hover:opacity-100 animate-color-cycle-3 animate-border-spin blur-sm" style={{ backgroundSize: '400% 400%' }}></div>
              <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm">
